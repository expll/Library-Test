...
+(id) sharedTestData
{
    static TestData *_sharedObject;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        _sharedObject = [[TestData alloc] init];
    });
...
-(id) init
{
    ...
    if (self) {
        self.imageUrls = [NSArray arrayWithObjects: 
                                             ...
                                             @"http://static2.dmcdn.net/static/video/176/845/38548671:jpeg_preview_small.jpg?20120414200742", nil];
    }
